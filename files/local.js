...
(0, _domready2['default'])(function () {
  ...
  setTimeout(function () {
    ...
    var $list = $navi.find('.local-navi-switch__list');
...
var Hero = function () {
  function Hero() {
    ...
    setTimeout(this._switchPic.bind(this), 1000);
  }
  ...
  Hero.prototype._switchPic = function _switchPic() {
    ...
    var $naviColor = $('#local-navi-switch');
    this._num++;
    this._num = (this._num + this._maxNum) % this._maxNum;

    this.$redInner.addClass('js-hide');
    $pic.addClass('js-zooming');
    $naviColor.addClass('bgClear');

    var redDuration = 800;
    var zoomDuration = 4000;

    setTimeout(function () {
      _this.$redInner.removeClass('js-hide').addClass('js-showStart');
      $naviColor.removeClass('bgClear');

      setTimeout(function () {
        _this.$redInner.addClass('js-show');
        setTimeout(function () {
          _this.$redInner.removeClass('js-show js-showStart');
          $pic.removeClass('js-zooming');
          setTimeout(_this._switchPic.bind(_this), 800);
        }, redDuration);
      }, 33);
    }, zoomDuration - redDuration - 33);
  };
...
},{"utils/GlanceNav":3,"utils/domready":8}],2:[function(require,module,exports){
"use strict";
...
var GlanceNav = function GlanceNav($list, $arrow) {
  ...
  Util.clearModules = function clearModules($area, moduleList) {
    _.forEach(moduleList, function (Klass, key) {
      _.forEach($area.find('[data-njs="' + key + '"]'), function (el) {
        var $el = $(el);
        var instance = $el.data('njs-instance');
